  ...
  implements GGButtonListener
{
  ...
  private int numberOfDice;   // added
  public int getNumberOfDice(){
    return numberOfDice;
  }

  public Cup cup = new Cup(this);
  ...
  private void roll(int rollNumber)
  {
    ...
    cup.roll(nb);   // added
    addActor(cup.getAllDice().get(cup.getAllDice().size() - 1), dieBoardLocation);  // changed the first parameter
  }
